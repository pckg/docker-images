...
echo "session.save_handler = redis" >> /etc/php/8.3/fpm/php.ini
echo "session.save_path = \"tcp://${REDIS_HOST##/cache-server-}:6379?auth="${REDIS_PASS}"\"" >> /etc/php/8.3/fpm/php.ini
